...
file = dir(['D:/Image Process/Images/OVA/Red' '/*.tif']);
n = numel(file);
...
%% Intensity Measurement
    ...
    writetable(T_int,'D:/Protein degradation paper/MATLAB/Intensity_2/OVA_PLL_intensity.xlsx','Range',range,'WriteVariableName',false);
